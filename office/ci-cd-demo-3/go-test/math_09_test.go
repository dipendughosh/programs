...
func TestSubtract09(t *testing.T) {
	if Subtract(5, 3) != 2 {
...
func TestMultiply09(t *testing.T) {
	if Multiply(2, 3) != 6 {
...
func TestWithAllure09(t *testing.T) {
	performAction(t)
