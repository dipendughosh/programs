...
func TestSubtract06(t *testing.T) {
	if Subtract(5, 3) != 2 {
...
func TestMultiply06(t *testing.T) {
	if Multiply(2, 3) != 6 {
...
func TestWithAllure06(t *testing.T) {
	performAction(t)
