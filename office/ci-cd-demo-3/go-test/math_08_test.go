...
func TestSubtract08(t *testing.T) {
	if Subtract(5, 3) != 2 {
...
func TestMultiply08(t *testing.T) {
	if Multiply(2, 3) != 6 {
...
func TestWithAllure08(t *testing.T) {
	performAction(t)
