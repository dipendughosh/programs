...
//Function to delete any element of the list
...
//Function to copy the list to a second list
...
//Function to sort the list in descending order by value
...
//Function to sort the list in ascending order by value
...
//Function to sort the list in descending order by node
...
//Function to sort the list in ascending order by node
...
//Function to count the number of elements of the list
...
//Function to find the frequency of the elements of the list
