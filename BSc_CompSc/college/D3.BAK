...
1.Checking if LEAP YEAR
2.Checking if the entered dates are VALID
3.Calculayting the days lapsed*/
int checkLeap(int);
int checkdate();
void calculation();
...
{       struct days d3;
	...
	if(d1.dd>=1 && d1.dd<=dinmon1 && d2.dd>=1 && d2.dd<=dinmon2 && d1.mm>=1 && d1.mm<12 && d2.mm>=1 && d2.mm<12 && d1.yyyy<=2007 && d2.yyyy<=2007)
		flag=1;
	else
	{	printf("\nRE-ENTER DATA\n");
		flag=0;
