...
Friend Class Form10
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		Label9.Text = rs.rdoColumns("DNAME").Value
		Label10.Text = rs.rdoColumns("CNO").Value
		Label11.Text = rs.rdoColumns("SECNO").Value
		Label12.Text = rs.rdoColumns("GRADE").Value
	End Sub
	...
	Private Sub Form10_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		rs = con.OpenResultset("SELECT * FROM ENROLL", RDO.ResultsetTypeConstants.rdOpenStatic)
		Label8.Text = rs.rdoColumns("SID").Value
		Label9.Text = rs.rdoColumns("DNAME").Value
		Label10.Text = rs.rdoColumns("CNO").Value
		Label11.Text = rs.rdoColumns("SECNO").Value
