...
Friend Class Form11
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		Label10.Text = rs.rdoColumns("SECNO").Value
		Label11.Text = rs.rdoColumns("PNAME").Value
	End Sub
	...
	Private Sub Form11_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		rs = con.OpenResultset("SELECT * FROM SECTION", RDO.ResultsetTypeConstants.rdOpenStatic)
		Label8.Text = rs.rdoColumns("DNAME").Value
		Label9.Text = rs.rdoColumns("CNO").Value
		Label10.Text = rs.rdoColumns("SECNO").Value
		Label11.Text = rs.rdoColumns("PNAME").Value
