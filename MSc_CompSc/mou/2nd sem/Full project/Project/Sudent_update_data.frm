...
Private Sub Command3_Click()
    Dim Q As String
    Q = "UPDATE STUDENT SET S_NAME = '" + Text1.Text + "',S_ADDRESS = '" + Text2.Text + "',S_CITY = '" + Text3.Text + "',S_PIN = " + Text4.Text + ",S_DOB = TO_DATE('" + Text5.Text + "','DD/MM/YYYY'),S_AGE = " + Text6.Text + ",S_MOBILE = " + Text7.Text + ",S_GENDER = '" + Text8.Text + "',S_FNAME = '" + Text9.Text + "',S_C_ID = '" + Text10.Text + "',S_FEES = " + Label14.Caption + " WHERE S_ID = '" + Label11.Caption + "';"
    con.Execute Q
    Form2.Text1.Text = ""
