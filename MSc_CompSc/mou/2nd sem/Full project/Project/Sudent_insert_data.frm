...
Private Sub Command3_Click()
    ...
    Label12.Caption = rs.rdoColumns("C_FEES")
    ...
    Else
        ...
        Q = "INSERT INTO STUDENT(S_ID,S_NAME,S_ADDRESS,S_CITY,S_PIN,S_DOB,S_AGE,S_MOBILE,S_GENDER,S_FNAME,S_C_ID,S_FEES) VALUES ('" + Text8.Text + "','" + Text1.Text + "','" + Text2.Text + "','" + Text3.Text + "'," + Text4.Text + ",TO_DATE('" + D1 + "','DD/MM/YYYY')," + Combo4.Text + "," + Text5.Text + ",'" + Combo5.Text + "','" + Text6.Text + "','" + Text7.Text + "'," + Label12.Caption + ");"
        con.Execute Q
        Text1.Text = ""
        Text2.Text = ""
        Text3.Text = ""
