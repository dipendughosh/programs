...
Private Sub Command3_Click()
    Dim Q As String
    Q = "UPDATE INSTRUCTOR SET I_NAME = '" + Text1.Text + "',I_ADDRESS = '" + Text2.Text + "',I_CITY = '" + Text3.Text + "',I_PIN = " + Text4.Text + ",I_DOB = TO_DATE('" + Text5.Text + "','DD/MM/YYYY'),I_AGE = " + Text6.Text + ",I_MOBILE = " + Text7.Text + ",I_GENDER = '" + Text8.Text + "',I_SALARY = " + Text9.Text + ",I_QUALIFICATION = '" + Text10.Text + "',I_DOJ = TO_DATE('" + Text11.Text + "','DD/MM/YYYY') WHERE I_ID = '" + Label11.Caption + "';"
    con.Execute Q
    Form5.Text1.Text = ""
