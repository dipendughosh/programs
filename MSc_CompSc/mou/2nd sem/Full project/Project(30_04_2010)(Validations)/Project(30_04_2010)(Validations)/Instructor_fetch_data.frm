...
Begin VB.Form Form5 
   ...
   ClientWidth     =   8100
   LinkTopic       =   "Form5"
   Picture         =   "Instructor_fetch_data.frx":0000
   ScaleHeight     =   8490
   ScaleWidth      =   8100
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackColor       =   &H80000009&
      Caption         =   "VIEW INSTRUCTOR'S DETAILS"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
...
Private Sub Command4_Click()
    ...
    FLAG1 = 0
    Set rs2 = con.OpenResultset("SELECT COUNT(*) AS C FROM INSTRUCTOR;", rdOpenStatic)
    N = rs2.rdoColumns("C")
    rs2.Close
    ...
    rs1.Close
    If Text1.Text = "" Then
        MsgBox ("Enter InstructorID")
    ElseIf FLAG1 = 0 Then
        MsgBox ("InstructorID provided is Absent")
    Else
        ...
        Label27.Caption = rs.rdoColumns("I_STATE")
        Label28.Caption = rs.rdoColumns("I_POLICE")
        rs.Close
    End If
End Sub
