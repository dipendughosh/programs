...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>MADHYA PRADESH TOUR AVAILABILITY</U></B></font></div>
</div></div>
<div id="htmlout" style="position:absolute; overflow:hidden; left:270px; top:250px; width:550px; height:550px; z-index:13">

<div id="html1" style="position:absolute; overflow:hidden; left:100px; top:5px; width:550px; height:550px; z-index:13">
<table border="5"><center><tr><td>Date Of Journey</td><td>Available Seats</td></tr>
<%
      try {
    	  Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/tour", "root", "");
			Statement st = (Statement) con.createStatement();
			ResultSet rs = (ResultSet) st.executeQuery("select date,availability from tour_schedule where title like 'madhya%'");

    while (rs.next()) {
    %>
    
        <div><font class="ws9" color="#666699\"><tr><td><%=rs.getString(1)%></td><td><%=rs.getString(2)%></td></tr><br/><br/></font></div>
...
<div id="nav10d" style="position:absolute; left:10px; top:270px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412959060a.gif',1)" href="photo7.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412959060a.gif')" alt="" border=0 src="images/nav412959060i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:185px; top:270px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412572960a.gif',1)" href="avail7.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412572960a.gif')" alt="" border=0 src="images/nav412572960i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:350px; top:270px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav411604840a.gif',1)" href="book7.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav411604840a.gif')" alt="" border=0 src="images/nav411604840i.gif"></a></div>
