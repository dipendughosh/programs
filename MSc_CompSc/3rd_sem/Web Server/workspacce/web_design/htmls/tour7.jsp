...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>MADHYA PRADESH TOUR SCHEDULE</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:270px; top:320px; width:550px; height:550px; z-index:13">
<pre>
MADHYA PRADESH( 8 DAYS PROGRAMME ) Rs. 13000/- per head
1st Day 	Howrah Station	: 	 
2nd Day 	Khajurah : 	
3rd Day 	Bhupal 	: 	
4th Day 	Jabbalpur : 	
5th Day 	Kanha Forest: 	
6th Day 	Kanha Tiger Safari 	: 	
7th Day 	Pachmari  	: 	
8th Day 	Return to Howrah 	: 	
</pre>
<div id="nav10d" style="position:absolute; left:10px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412959060a.gif',1)" href="photo7.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412959060a.gif')" alt="" border=0 src="images/nav412959060i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:185px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412572960a.gif',1)" href="avail7.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412572960a.gif')" alt="" border=0 src="images/nav412572960i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:350px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav411604840a.gif',1)" href="book7.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav411604840a.gif')" alt="" border=0 src="images/nav411604840i.gif"></a></div>
