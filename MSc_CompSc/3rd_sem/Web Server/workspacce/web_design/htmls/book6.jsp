...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>RAJASTHAN TOUR BOOKING</U></B></font></div>
</div></div>
...
Tour Name:  <input type="text" name="tname" id="tname" value="Rajasthan"/><br/><br/>
...
<%
      try {
    	  Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/tour", "root", "");
			Statement st = (Statement) con.createStatement();
			ResultSet rs = (ResultSet) st.executeQuery("select date from tour_schedule where title like 'rajasthan%'");
