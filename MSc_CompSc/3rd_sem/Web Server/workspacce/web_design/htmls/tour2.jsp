...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>KINNAUR TOUR SCHEDULE</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:270px; top:320px; width:550px; height:550px; z-index:13">
<pre>
KINNAUR-KAILASH ( 12 DAYS PROGRAMME ) Rs. 15000/- per head
1st Day 	Howrah 	: 	 
2nd Day 	On Road 	
3rd Day 	Simla 	: 	
4th Day 	Sarahan : 	
...
<div id="nav10d" style="position:absolute; left:10px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412959060a.gif',1)" href="photo2.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412959060a.gif')" alt="" border=0 src="images/nav412959060i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:185px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412572960a.gif',1)" href="avail2.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412572960a.gif')" alt="" border=0 src="images/nav412572960i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:350px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav411604840a.gif',1)" href="book2.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav411604840a.gif')" alt="" border=0 src="images/nav411604840i.gif"></a></div>
