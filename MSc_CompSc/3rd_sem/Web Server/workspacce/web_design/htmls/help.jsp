...
<title>Paradise Tour And Travels:: Tour Schedule- Kinnaur</title>
<style type="text/css">
/*----------Text Styles----------*/
.ws6 {font-size: 8px;}
.ws7 {font-size: 9.3px;}
...
<div class="wpmd">
<div><font face="Tahoma">Designed And Developed By dept. of Computer Science And Engineering 2010-2011</font></div>
</div></div>
...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>PARADISE TOUR AND TRAVELS</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:270px; top:320px; width:550px; height:550px; z-index:13">
<pre><font face="Arial" size=3 color="green">
<b>			Our Services:</font><font face="Arial" size=2 color="green">
<b><ul type="square">
	<li> Package Tour All Over India</li>
	<li> International/Domestic Air Ticket</li>
	<li> Car & Bus Rental All Over India</li>
	<li> Hotel Booking All Over India</li></ul></font><font face="Arial" size=3 color="green"><b>
For More Details Contact or Mail us.
We are always Ready To Help You. Thank You!!!</b>
</font>
</pre>
</div>
