...
<%
   ...
   String date = request.getParameter("day"+"month"+"year");
   String availability = request.getParameter("availability");
   String amount_per_head = request.getParameter("amount_per_head");
 
   /* Create string of connection url within specified 
   format with machine name, 
    port number and database name. Here machine name id 
    localhost and database name is tour. */
    String connectionURL = "jdbc:mysql://localhost:3306/tour";
   ...
   Statement statement=null;
    ...
    // Load JBBC driver "com.mysql.jdbc.Driver"
	 ...
	 if(tour_id!=null && title!=null && availability!=null && amount_per_head!=null && date!=null){

		 // check if the text box having only blank spaces
	     if(tour_id!="" && title!="" && availability!="" && amount_per_head!="" && date!="") {
...
<div class="wpmd">
<div><font color="#666699" class="ws9"><B>MENU</B></font></div>
...
<div id="text2" style="position:absolute; overflow:hidden; left:380px; top:154px; width:458px; height:20px; z-index:14">
<div class="wpmd">
...
<div id="text2" style="position:absolute; overflow:hidden; left:35px; top:254px; width:458px; height:20px; z-index:14">
<div class="wpmd">

<div><font face="Tahoma"><B><a href="addsl.jsp" title="" class="style1">ADD NEW SCHEDULE</a></B></font></div>
</div></div>
<div id="text2" style="position:absolute; overflow:hidden; left:35px; top:334px; width:458px; height:20px; z-index:14">
<div class="wpmd">

<div><font face="Tahoma"><B><a href="addsl.jsp" title="" class="style1">UPDATE SCHEDULE</a></B></font></div>
</div></div>


<div id="text2" style="position:absolute; overflow:hidden; left:35px; top:414px; width:458px; height:20px; z-index:14">
<div class="wpmd">

<div><font face="Tahoma"><B><a href="addsl.jsp" title="" class="style1">UPDATE PHOTOGALLERY</a></B></font></div>
</div></div>
<div id="text2" style="position:absolute; overflow:hidden; left:35px; top:494px; width:458px; height:20px; z-index:14">
<div class="wpmd">

<div><font face="Tahoma"><B><a href="addsl.jsp" title="" class="style1">UPDATE WHATS NEW</a></B></font></div>
</div></div>
...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>ADD TOUR SCHEDULE</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:320px; top:345px; width:350px; height:550px; z-index:13">
<form name="addsl" id="addsl" action="addsl.jsp" method="POST">

<font face="Tahoma" class="ws9" color="#666699">
<b>ADD TOUR SCHEDULE<br><br/><br/>
<b>
Tour_id:
<input type="text" name="tour_id" id="tour_id"/></b><font color="red"></font><b>
<br />
<br />
Title:
<input type="text" name="title" id="title" /></b><font color="red"></font><b>
<br />
<br />
...
<br />
Availability:
<input type="text" name="availability" id="availability" /><font color="red"></font>
<br />
<br />
Amount per_Head:
<input type="text" name="amount_per_head" id="amount_per_head" />
<br />
<br />


<input type="image" name="submit" width="136" height="27" src="images/submit.gif"/>
