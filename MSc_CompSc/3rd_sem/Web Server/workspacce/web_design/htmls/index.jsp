...
<%
      try {
    	  Class.forName("com.mysql.jdbc.Driver");
			...
			ResultSet rs = (ResultSet) st.executeQuery("select * from whats_new");

    while (rs.next()) {
    %>
    
        <div><font class="ws9" color="#666699\"><%=rs.getString(1)%><br/><br/></font></div>
...
<div id="slideshow1" style="position:absolute; overflow:hidden; left:382px; top:225px; width:382px; height:436px; z-index:12">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="382" height="436" id="tech" align="middle" quality="high" allowFullScreen="true" wmode="transparent" allowScriptAccess="always">
    ...
    <embed src="images/flash1.swf" width="382" height="286" quality="high" allowFullScreen="true" wmode="transparent" allowScriptAccess="always" name="tech" align="middle" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
  </object>

</div>

<div id="text1" style="position:absolute; overflow:hidden; left:221px; top:227px; width:141px; height:435px; z-index:13">
<div class="ws12">
<div><font color="#000080">PARADISE tour and travels is a real heaven for the travelers.It is one the oldest but still modern traveling agency.It conducts near about 50 tours round the year.PARADISE agency was established on 28th July 1995,taking the hand of Mr. Jayanta Mukherjee,the founder of PARADISE travel agency. Now it is going on with full leaves and branches. Customer satisfaction is our only motto.we also have a TV channel program named "Beranor Dunia".  </font>.<font class="ws11"> </font></div>
</div></div>


<div id="text2" style="position:absolute; overflow:hidden; left:299px; top:154px; width:458px; height:20px; z-index:14">
<div class="wpmd">
<div><font face="Tahoma"><B><a href="authen.jsp" title="" class="style1">AUTHORITY LOGIN</a></B></font><font color="#333333" face="Tahoma"><B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </B></font><font face="Tahoma"><B><a href="schedule.jsp" title="" class="style1">CHECK TOUR SCHEDULE</a></B></font><font color="#333333" face="Tahoma"><B>&nbsp;&nbsp;&nbsp; </B></font><font face="Tahoma"><B><a href="help.jsp" title="" class="style1">HELP</a></B></font><font color="#333333" face="Tahoma"><B>&nbsp;&nbsp;&nbsp; </B></font><font face="Tahoma"><B><a href="contact.jsp" title="" class="style1">CONTACTS</a></B></font></div>
</div></div>


<div id="text3" style="position:absolute; overflow:hidden; left:196px; top:700px; width:569px; height:163px; z-index:15">
<div class="ws14">
<UL>
<li><font color="#000080"> In 2001 the PARADISE was awarded the status of a five star agency by the National Traveling Assessment Council.</font></li>
<li><font color="#000080">Established : 28th July, 1995</font></li>
<li><font color="#000080">Founder: Lt. Jayanta Mukherjee </font></li>
</UL>
