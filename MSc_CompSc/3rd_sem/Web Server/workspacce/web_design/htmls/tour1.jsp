...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>ANDAMAN TOUR SCHEDULE</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:270px; top:320px; width:550px; height:550px; z-index:13">
<pre>
ANDAMAN & NICIBAR ( 8 DAYS PROGRAMME ) Rs. 35000/- per head
1st Day 	Dumdum Airport	: 	 
2nd Day 	PortBlayer 	
3rd Day 	PortBlayer 	: 	
4th Day 	Coral View : 	
5th Day 	PortBlayer  : 	
6th Day 	Nicobar 	: 	
7th Day 	Nicobar  	: 	
8th Day 	Return to Kolkata 	: 	
</pre>
<div id="nav10d" style="position:absolute; left:10px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412959060a.gif',1)" href="photo1.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412959060a.gif')" alt="" border=0 src="images/nav412959060i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:185px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav412572960a.gif',1)" href="avail1.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav412572960a.gif')" alt="" border=0 src="images/nav412572960i.gif"></a></div>
<div id="nav10d" style="position:absolute; left:350px; top:230px; z-index:0"><a onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('nav10','','images/nav411604840a.gif',1)" href="book1.jsp"><img name="nav10" onLoad="MM_preloadImages('images/nav411604840a.gif')" alt="" border=0 src="images/nav411604840i.gif"></a></div>
