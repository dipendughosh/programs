...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>MADHYA PRADESH TOUR BOOKING</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:270px; top:320px; width:550px; height:550px; z-index:13">
<form name="b1" id="b1" action="serv1" method="POST">
<center>
<font face="Tahoma" class="ws9" color="#666699"><b>
Tour Name:  <input type="text" name="tname" id="tname" value="Madhya Pradesh"/><br/><br/>
On Date :  <select name="date">
...
<%
      try {
    	  Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/tour", "root", "");
			Statement st = (Statement) con.createStatement();
			ResultSet rs = (ResultSet) st.executeQuery("select date from tour_schedule where title like 'madhya%'");
...
<br/><br/>
Credit Card No:<font color="red">*</font>  <input type="text" name="cno" id="cno"/><br/><br/><br/><br/>
</b></font>
<input type="image" name="formimage2" width="136" height="27" src="images/submit.gif">
</center>
</form>
