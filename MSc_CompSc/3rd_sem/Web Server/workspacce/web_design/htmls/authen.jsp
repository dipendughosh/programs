...
function v()
{
	if(document.authen.user.value=="paradise" and document.authen.password.value=="aptravels")
		return true;
	else 
		return false;
}
...
<div class="wpmd">
<div align=center><font color="#000080" face="Algerian" class="ws24"><B><U>AUTHORITY LOGIN</U></B></font></div>
</div></div>

<div id="html1" style="position:absolute; overflow:hidden; left:320px; top:345px; width:350px; height:550px; z-index:13">
<form name="authen" id="authen" action="addsl.jsp" method="POST" onsubmit="return v()">
<center>
<font face="Tahoma" class="ws9" color="#666699">
<b>Log in<br><br/><br/>
Username:  <input type="text" name="user" id="user"/><br/><br/><br/><br/>
Password :  <input type="password" name="password" id="password"/><br/><br/><br/><br/>
</b>
<input type="submit" name="formimage2" value="SUBMIT" >
</center>
</form>
</div>
