...
public class SearchResourceServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
             ...
             String s="select * from APP.RESOURCE where type='"+type+"'";
             ...
             while (records.next())
             {
                ...
                out.println("<tr>");
                out.println("<td>"+records.getString("RESOURCEID")+"</td><td>" + records.getString("NAME") +"</td><td>"+ records.getString("TYPE") +"</td><td>"+ records.getString("CATEGORY")+"</td><td>"+records.getString("AUTHORNAME")+ "</td><td>"+records.getInt("NO_OF_COPIES")+"</td><td>" +  records.getInt("AVAILABLE")+"</td>");
                out.println("</tr>");
             }
