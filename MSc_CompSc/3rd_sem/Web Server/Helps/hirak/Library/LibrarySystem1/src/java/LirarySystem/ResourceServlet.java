...
public class ResourceServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String no_of_copies= request.getParameter("no_of_copies").toString();
        ...
        try
        {
             ...
             String s="insert into App.Resource values('"+ resourceid +"','"+name+"','"+type+"','"+category+"','"+authorname+"','"+no_of_copies+"','"+no_of_copies+"')";
