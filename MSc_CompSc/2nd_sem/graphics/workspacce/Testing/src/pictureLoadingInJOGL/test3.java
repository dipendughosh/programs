...
public class HWShadowmapsSimple extends Demo {
  ...
  public void init(GLAutoDrawable drawable) {
    ...
    try {
      decal = TextureIO.newTexture(getClass().getClassLoader().getResourceAsStream("pictureLoadingInJOGL/images/decal_image.png"),
                                   true,
                                   TextureIO.PNG);
      decal.setTexParameteri(GL.GL_TEXTURE_WRAP_S, GL.GL_REPEAT);
      decal.setTexParameteri(GL.GL_TEXTURE_WRAP_T, GL.GL_REPEAT);
      light_image = TextureIO.newTexture(getClass().getClassLoader().getResourceAsStream("pictureLoadingInJOGL/images/nvlogo_spot.png"),
                                         true,
                                         TextureIO.PNG);
    } catch (IOException e) {
