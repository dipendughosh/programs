...
import pictureLoadingInJOGL.DemoListener;
/*import demos.common.*;
import demos.util.*;
import gleem.*;
import gleem.linalg.*;*/
...
public class test2 extends Canvas implements GLEventListener{
...
"END\n";
  ...
  public void init(GLAutoDrawable drawable) {
    ...
    try {
      cubemap = loadFromStreams(getClass().getClassLoader(),
                                        "pictureLoadingInJOGL/images/cubemaps/uffizi_",
                                        "png",
                                        true);
    } catch (IOException e) {
      shutdownDemo();
