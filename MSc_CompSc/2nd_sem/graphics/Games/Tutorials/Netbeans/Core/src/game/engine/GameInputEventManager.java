 ...
 */
public class GameInputEventManager implements 
        KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {

    ///////////////////////////////////////////////////////////////////////////
    // Class data: Keyboard event inputs                                     //
    ///////////////////////////////////////////////////////////////////////////
    ...
    public final void mouseReleased(MouseEvent event) {
        ...
        // Check to see if the mouse release can be interpretated as a click
        if (Math.abs(event.getX() - mousePressXLocation) < mouseClickTolerance 
                && Math.abs(event.getY() - mousePressYLocation) < mouseClickTolerance) {
            mouseClicked(event);
        }
    }
