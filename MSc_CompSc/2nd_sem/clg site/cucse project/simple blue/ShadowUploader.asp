<%
'constants:
Const MAX_UPLOAD_SIZE=300000 'bytes
		...
		If iBytesCount>MAX_UPLOAD_SIZE Then
           ...
           %>
              ...
              <script language="javascript">
                 <!--
                    alert('Image File is too large!Maximum allowable size is 300Kb!');
                 //-->
               </script>
               <%
			Exit Sub
...
Class FileData
	...
	Public Sub SaveToDisk(strFolderPath, ByRef strNewFileName)
		...
		arrTemp = Split(strImageName, ".")
         ...
         Response.Write("path: "&Server.MapPath(strThumbName)&"<br />")
		 strURL= "http://cucse.org/alumni/ImageResizer.aspx?image=" & Serevr.MapPath(strImageName) & "&thumb=" & Server.MapPath("alumni/Thumbs/" &strThumbName) & "&width=200&height=200"
