...
void JPakeParameters_Init(struct JPakeParameters *param)
{
      ...
      printf("\nPrime number p = %llu",param->p);
      printf("\nGenerator g = %llu",param->g);
}
...
unsigned long long verifier(int user,int ss,int sss,unsigned long long r,unsigned long long c,unsigned long long s,unsigned long long x)
{
...
unsigned long long zkp(struct JPakeUser *from,struct JPakeUser *to,struct JPakeParameters *param,int ss)
{
      int f1=1,f2=1,u;
	  ...
	  //Knowledge proof for x1 of Alice or knowledge proof for x3 of Bob
          ...
          //Knowledge proof for x2 of Bob or knowledge proof for x4 of Alice
...
{
      unsigned long long k=user->key,s;
