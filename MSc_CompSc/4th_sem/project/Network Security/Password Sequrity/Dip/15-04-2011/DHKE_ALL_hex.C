...
void attacker()
{
   ...
   do
   {
    	printf("\nEnter the 1st private key for attacker in hex : ");
		fflush(stdin);
		gets(string);
   ...
   do
   {
    	printf("\nEnter the 2nd private key for attacker in hex : ");
		fflush(stdin);
		gets(string);
...
void user_a()
{
   ...
   do
   {
    	printf("\nEnter user A's private key in hex :- ");
   	fflush(stdin);
		gets(string);
...
void user_b()
{
   ...
   do
   {
    	printf("\nEnter user B's private key in hex :- ");
   	fflush(stdin);
		gets(string);
