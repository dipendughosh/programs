...
{	
	...
	$display_string .= '<table align= center border= 1 cellspacing=2 height=10 width=500>';
	$display_string .="<tr><th colspan='8' align='center' style='background-color:#E4F8FA'>National</th></tr>";	
	$display_string .= "<tr>";
	$display_string .= "<th style='background-color:#E4F8FA'>TYPE OF PROGRAMME</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>NUMBER OF SUCH PROGRAMMES</th>";
	$display_string .= "</tr>";	
	...
	$display_string .="<tr><th colspan='8' align='center' style='background-color:#E4F8FA'>International</th></tr>";	
	$display_string .= "<tr>";
	$display_string .= "<th style='background-color:#E4F8FA'>TYPE OF PROGRAMME</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>NUMBER OF SUCH PROGRAMMES</th>";
	$display_string .= "</tr>";	
...
{	
	...
	//$display_string  = '<table style="float:center" border= 2 cellspacing=2 height=20 width=500 class="main">';
	//$display_string .="<tr><th colspan='8'><center>National</center></th></tr></table>";
	$display_string .='<table align="center" border= 1 cellspacing=2 height=20 width=500>';
	//$display_string .="<caption>National</caption>";
	$display_string .="<tr><th colspan='8' align='center' style='background-color:#E4F8FA'>National</th></tr>";
	$display_string .= "<tr>";
	$display_string .= '<th style="background-color:#E4F8FA">Name of Faculty</th>';
	$display_string .= "<th style='background-color:#E4F8FA'>Faculty Development Programe</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>Workshops</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>Conferences</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>Staff Development Training Programe</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>Foreign Training Programe</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>Programes Under Networking Of Institutions</th>";
	$display_string .= "<th style='background-color:#E4F8FA'>Total Activities</th>";
	$display_string .= "</tr>";
...
/* INTERNATIONAL */
		...
		$display_string .= '<table align="center" border= 1 cellspacing=2 height=20 width=867>';
		$display_string .="<tr><th colspan='8' align='center' style='background-color:#E4F8FA'>International</th></tr>";
		$display_string .= "<tr>";
		$display_string .= '<th style="background-color:#E4F8FA">Name of Faculty</th>';
		$display_string .= "<th style='background-color:#E4F8FA'>Faculty Development Programe</th>";
...
{	
	...
	{		
		...
		$display_string .= "<tr>";
		$display_string .= "<td width='30%'>$PD_p_id_row[PD_name]</td>";
		$display_string .= "<td width='30%'>$FDProgRow[NUMBER]</td>";
		
		/* WORKSHOP */
		$WORKshop = mysql_query("SELECT count(*) 'NUMBER' from conference_attended where CONF_c_id in( select CONF_c_id from conference where CONF_type = 'Workshops' and CONF_s_date >='$VW_CONF_FROM_date' and CONF_s_date <='$VW_CONF_TO_date') and PD_p_id='$PD_p_id_row[PD_p_id]';");		
