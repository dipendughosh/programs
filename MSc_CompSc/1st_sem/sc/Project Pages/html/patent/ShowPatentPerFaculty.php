...
function c1($PD_pid)
{
	global $display_string;	 	$result1 = mysql_query("select PAT_researcher,A.PAT_pid 'PATPID' ,PAT_topic,PAT_patent_no from patent A,patents_per_faculty B where A.PAT_pid=B.pat_pid and B.PD_p_id='$PD_pid';");
	...
	{
		$display_string .= "<tr>";
		$display_string .= "<td>$row1[PAT_researcher]</td>";
