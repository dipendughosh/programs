<?php
	...
	$qsql="INSERT INTO personal_details(PD_name,PD_dob,PD_male,PD_address,PD_pin,PD_landline,PD_mobile,PD_mobile,PD_email,PD_doj,PD_quali,PD_type,PD_post,PD_special) VALUES ('$PD_name','$PD_dob','$PD_male','$PD_address','$PD_pin','$PD_landline','$PD_mobile','$PD_email','$PD_doj','$PD_quali','$PD_type','$PD_post','$PD_special')";
