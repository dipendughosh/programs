<?php
   ...
   $con = mysql_connect("localhost","root","hh");
	if (!$con)
	{
	...
	$PUBsql="INSERT INTO publications(PUB_id,PUB_topic,PUB_read_conference,PUB_volume_no,PUB_pub_date) VALUES ('$PUB_id','$PUB_topic','$PUB_read_conference','$PUB_volume_no','$PUB_pub_date')";
	echo $PUBsql;
