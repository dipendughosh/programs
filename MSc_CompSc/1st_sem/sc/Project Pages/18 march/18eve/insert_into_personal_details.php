<?php
	...
	$con = mysql_connect("localhost","root","gg");
	if (!$con)
	{
	...
	{*/
		...
		$PD_p_id=$_GET['PD_p_id'];echo $PD_p_id;
	...
	$PDsql="INSERT INTO personal_details(PD_p_id,PD_name,PD_dob,PD_sex,PD_address,PD_pin,PD_landline,PD_mobile,PD_email,PD_doj,PD_quali,PD_type,PD_post,PD_special) VALUES ('$PD_p_id','$PD_name','$PD_dob','$PD_sex','$PD_address','$PD_pin','$PD_landline','$PD_mobile','$PD_email','$PD_doj','$PD_quali','$PD_type','$PD_post','$PD_special');";
