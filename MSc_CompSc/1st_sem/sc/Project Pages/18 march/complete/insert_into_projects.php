<?php
   ...
   $con = mysql_connect("localhost","root","");
	...
	//{
		...
		$PR_typeofproject=$_GET['PR_type'];
		$PR_status=$_GET['PR_status'];
				
		$PRsql="INSERT INTO projects(PR_id,PR_topic,PR_headname,PR_fundedby,PR_type,PR_status) VALUES ('$PR_id','$PR_topic','$PR_headname','$PR_fundedby','$PR_typeofproject','$PR_status')";
		echo $PRsql;
