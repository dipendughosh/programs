...
<title>PROJECT WEBSITE BY M.Sc.</title>
...
$query="SELECT * FROM stdetail, stmarks WHERE stdetail.formno = stmarks.formno AND stdetail.ggroup='commerce' ORDER BY ttotal DESC";
