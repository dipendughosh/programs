...
$query="SELECT * FROM stdetail, stmarks WHERE stdetail.formno = stmarks.formno AND stdetail.ggroup='language' ORDER BY ttotal DESC";
...
}if($e==0)
{
  echo "<script language=\"javascript\">\n";
		...
		echo "document.location.href='langmerit.html' ";
		echo "</script>";
}
echo "</table>";
}
