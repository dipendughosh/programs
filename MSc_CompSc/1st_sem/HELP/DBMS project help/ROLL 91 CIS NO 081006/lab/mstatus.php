...
$query="SELECT mid,status FROM machine WHERE mid='$n1'";
...
if($count==0)
{
  echo "<script language=\"javascript\">\n";
		...
		echo "document.location.href='mstatus.html' ";
		echo "</script>";
}
else
{
...
<td width=10% bgcolor=#F4EBBE rowspan=3>&nbsp;</td>
 ...
 <legend align=center>Machine Status</legend>
...
<i><font color="#0000FF" face="Courier" size="4"><span style="background-color: #FFFFFF"><b>
    Machine id No:</b></span></font></i><font color="#0000FF" face="Courier" size="4"><i><b><?=$t1?></b></i></font>




<i><font color="#0000FF" face="Courier" size="4"><span style="background-color: #FFFFFF"><b>
    Status       :</b></span></font></i><font color="#0000FF" face="Courier" size="4"><i><b><?=$t2?></b></i></font>
