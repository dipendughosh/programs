//DC MOTOR CONTROLLER(SEPTEMBER 2005)STOP(DONE)
#include<iostream.h>
#include<graphics.h>
#include<process.h>
#include<iomanip.h>
...
{	clrscr();
	...
	text(8,13);
	outtextxy(188,50,"-:D C M O T O R:-");
	text(8,13);
	outtextxy(195,70,"-:Control Panal:-");
	text(6,4);
	outtextxy(85,300,"Instructions:-");
	outtextxy(210,140,"  Start:-");
	outtextxy(360,140,"    Stop:-");
	...
	text(5,10);
	outtextxy(100,320,"#Press & hold 'Start' button to start DC motor.");
	outtextxy(100,340,"#Press & hold 'Stop' button to stop DC motor.");
	outtextxy(100,360,"#Press 'Increase'/'Decrease' button to change the speed.");
	setcolor(35);
	outtextxy(85,380,"Made by:-");
	outtextxy(100,400,"  Dipendu Ghosh,Dipayan Karmakar,");
	outtextxy(100,420,"  Debodeep Roy Choudhury,Gaurav Gupta");
	setcolor(13);
