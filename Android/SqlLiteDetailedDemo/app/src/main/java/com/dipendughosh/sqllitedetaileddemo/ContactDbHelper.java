...
public class ContactDbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(DROP_TABLE);
        onCreate(db);
        Log.d("Database Operation", "Table re-created");
    }

    public void addContact(int contact_id, String name, String email, SQLiteDatabase database) {

        ContentValues contentValues = new ContentValues();
        contentValues.put(ContactContract.ContactEntry.CONTACT_ID, contact_id);
        ...
        Log.d("Database Operation", "Row insterted");
